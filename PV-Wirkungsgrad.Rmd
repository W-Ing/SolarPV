...
function.names <- c("norm_max_norm","norm_2wurzel_aus_2pot","norm_3wurzel_aus_3pot") # Abstandsnormen
num <- 3  # Waehle aus
waehle_norm_fu<- get(function.names[num])
merke_norm_fu <-  function.names[num]
#cat("Gewählte Abstandsnorm:", as.character(quote(norm_2wurzel_aus_2pot))," \n") 
...
Die Modellierung mit Hilfe zweier konstanter Wirkungsgrade ist ersichtlich wenig trennscharf: Die beste Approxiamtionsqualität wird entlang einer Kurve erreicht, die vermutlich durch das Produkt eta_1 mal eta_2 = constant beschrieben wird. 

Zum Vergleich: Verlauf des gemessenen und des modellierten Ladezustands

```{r echo=FALSE, fig.width=16, warning=FALSE}

subtitel_char <- paste("grün: tatsächlich, blau: modelliert mit eta_1 = ", eta_1, "und eta_2 = ",eta_2," optimiert bzl.", merke_norm_fu )
ggplot(lade_data) +
