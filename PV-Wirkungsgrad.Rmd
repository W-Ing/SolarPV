...
verb_u_erzeugung <- function(verb.data, dauer, v_oder_e,Text){
qdauer = enquo(dauer)

mnumber  <- ifelse(Text == "Monat", 12, 52)
xText    <- ifelse(Text == "Monat", "Monat", "Kalenderwoche")
yText    <- ifelse(v_oder_e == "Verbrauch", "Verbrauch (kWh)", "Von PV-Anlage erzeugt (kWh)")
...
verb_u_erzeugung(verbrauch, week, "Verbrauch", "Woche")
verb_u_erzeugung(verbrauch, month,"Verbrauch", "Monat")
verb_u_erzeugung(verbrauch, week, "Erzeugung", "Woche")
verb_u_erzeugung(verbrauch, month, "Erzeugung", "Monat")
