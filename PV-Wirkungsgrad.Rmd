...
batt_kapazitaet <- 0.93 # von 10 kWh
...
Es werden die zeitlichen Strecken erfasst, in denen die Ladebilanz (batt_ladung-batt_entladung) konstantes Vorzeichen (+/-1 oder 0) hat.Das Resultat des Ladevorgangs wird mit der Änderung des Ladezustands verglichen. Problematisch ist dabei, dass die Erfassung des Ladezustands wesentlich gröber ist (Schritte von 100 Wh) als die des Ladevorgangs. 
...
### Bilanzierung der Differenzen im Ladezustand im Vergleich zu den Lade-/Entladevorgängen ###
